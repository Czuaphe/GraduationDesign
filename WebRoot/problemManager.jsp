...
<script>
    ...
    $(document).ready(function(){
        $.get("/problem/show/teacher", function(response){
        ...
        $("#update").click(function(){
            ...
            else if(require.length == 0)
            {
                ...
                $.post("/problem/update", {infos : info}, function(response){
                    if(response.status == true) {
                        alert("修改成功！");
                        stu_id = -1;
    ...
    function edit(target) {
        ...
        $.get("/problem/details/teacher?pro_id=" + id, function(response){
            if(response.status == true) {
