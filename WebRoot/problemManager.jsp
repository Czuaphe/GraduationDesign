...
<script>
    ...
    $(document).ready(function(){
        $.get("http://10.165.215.202:8080/GraduationDesign/problem/show/teacher", function(response){
            if(response.status == true) {
                ...
                $("#problemInfo").dynamicTables({
                    ...
                    'noAdd': true,
                    'noSave': true,
                    'delsURL': 'http://10.165.215.202:8080/GraduationDesign/problem/dels',
                    'typeConfig': [
                        {"edit": false},
                        {"edit": false},
                        {"edit": false},
        ...
        $("#update").click(function(){
            ...
            else if(require.length == 0)
            {
                ...
                $.post("http://10.165.215.202:8080/GraduationDesign/problem/update", {infos : info}, function(response){
                    if(response.status == true) {
                        alert("修改成功！");
                        stu_id = -1;
    ...
    function edit(target) {
        ...
        $.get("http://10.165.215.202:8080/GraduationDesign/problem/details/teacher?pro_id=" + id, function(response){
            if(response.status == true) {
