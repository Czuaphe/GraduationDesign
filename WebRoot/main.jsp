...
<script>
    ...
    $(document).ready(function () {
        ...
        $("#choose").click(function(){
            if(pro_id != -1) {
                $.post("http://10.165.215.202:8080/GraduationDesign/student/select", {pro_id:pro_id}, function (response) {
        ...
        $("#problemList").on('click', ".list-group-item", function(){
            if($(this).hasClass('active')) {
                ...
                $.get("http://10.165.215.202:8080/GraduationDesign/problem/details/student?pro_id=" + id, function (response) {
                    if(response.status == true) {
    ...
    function update(page) {
        ...
        $.get("http://10.165.215.202:8080/GraduationDesign/problem/show/major?currentPage=1", function(response){
            if(response.status == true) {
                str = '';
