...
<script>
    ...
    $(document).ready(function() {
        $.get("/GraduationDesign/student/show?currentPage=1", function (response) {
            if (response.status == true) {
                $("#info").html("");
                $("#studentInfo").dynamicTables({
                    'title': ['编号', '学号', '姓名', '性别', '所属专业', 'QQ', '联系方式', '电子邮件', '备注'],
                    'data': response.data,
                    'delsURL': '/GraduationDesign/student/dels',
                    'saveURL': '/GraduationDesign/student/update',
                    'addURL': '/GraduationDesign/student/add',
                    'paginationURL': '/GraduationDesign/student/show',
